# Recruiting Companions — The Communion Rite
...
A companion's caste is detected automatically from the staff it carries (a Rogue carries no staff). Caste decides which [chores](Companion-Chores) it can take on and how it grows when it [levels](Companion-Leveling).
...
### A word of warning — the butcher knife
